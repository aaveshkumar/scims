        ...
        <form method="POST" action="/students">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <select name="gender" class="form-select <?= hasErrors('gender') ? 'is-invalid' : '' ?>">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="date" name="date_of_birth" class="form-control <?= hasErrors('date_of_birth') ? 'is-invalid' : '' ?>" value="<?= htmlspecialchars(old('date_of_birth', '')) ?>">
