...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="bi bi-plus-circle me-2"></i>Add Visitor</h2>
    <a href="/hostel/visitors" class="btn btn-secondary">
        <i class="bi bi-arrow-left me-2"></i>Back to Visitors
    </a>
</div>

<form method="POST" action="/hostel/visitors" class="card">
    <?= csrf_field() ?>
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="visitor_id_proof" name="visitor_id_proof" class="form-control" placeholder="e.g., PAN, Aadhaar">
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="purpose" name="purpose" class="form-control" placeholder="e.g., Regular visit, Birthday">
                </div>
            </div>
        </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3">
                <div class="mb-3">
                    ...
                    <input type="time" id="entry_time" name="entry_time" class="form-control" required>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="mb-3">
                    ...
                    <input type="time" id="exit_time" name="exit_time" class="form-control">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card-footer bg-light">
        <button type="submit" class="btn btn-success">
            <i class="bi bi-check-circle me-2"></i>Add Visitor
        </button>
        <a href="/hostel/visitors" class="btn btn-secondary">
