                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm" role="group">
                                        <a href="/quizzes/<?= $quiz['id'] ?>" class="btn btn-outline-primary" title="View">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="/quizzes/<?= $quiz['id'] ?>/edit" class="btn btn-outline-warning" title="Edit">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <form method="POST" action="/quizzes/<?= $quiz['id'] ?>/delete" style="display: inline;" onsubmit="return confirm('Delete this quiz?');">
