...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h3 mb-0">Create Payroll</h1>
        <p class="text-muted mb-0">Add staff payroll record</p>
    </div>
...
<div class="card">
    <div class="card-body">
        <form method="POST" action="/hr/payroll/create">
            ...
            <div class="mb-4">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="month" class="form-control" placeholder="January, February, etc." required>
                    </div>
                    <div class="col-md-6 mb-3">
            ...
            <div class="mb-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="payment_method" class="form-control" placeholder="Bank Transfer, Cash, etc.">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-check-circle me-2"></i>Create Payroll
                </button>
